...
<html>
    ...
    <body>
        ...
        <center>
            ...
            <br>
            <a href="penjualan.php?expand=true" class="btn btn-outline-light" style="border-color:#45a29e; color:white;" onMouseOver="this.style.background='#45a29e'; this.style.color='white';" onMouseOut="this.style.background='none'; this.style.color='white';">Kembali</a>
        </center>
        <br><br><br>
