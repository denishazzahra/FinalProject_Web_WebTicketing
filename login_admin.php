    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item" style="float:right;">
                            <a class="nav-link active" style="color:#66fcf1;" href="login_admin.php">Admin</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <center>
            ...
            <table class="loginregister">
                <form method="POST" action="cek.php?menu=login_admin">
                    <tr>
                        <td>
                            <?php
                                if(isset($_GET['pesan']))
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-outline-light" style="border:solid 1.5px #45a29e;" onMouseOver="this.style.background='#45a29e'; this.style.color='white';" onMouseOut="this.style.background='none'; this.style.color='white';">LOGIN</button>
                            </div>
                        </td>
                    </tr>
                </form>
