    ...
    <body>
        ...
        <center>
            ...
            <table class="loginregister">
                <form method="POST" action="cek.php?menu=register_user">
                    <tr>
                        <td>
                            <?php
                                if(isset($_GET['pesan']))
                                {
                                    ...
                                    {
                                        echo '<p align="center" style="font-size:11pt; line-height:0.8;"><br>'."Username telah terdaftar sebelumnya".'</p><br>';
                                    }
                                }
                                else
                                {
                                    echo '<p align="center" style="font-size:11pt; line-height:0.8;"><br><br></p><br>';
                                }
                            ?>
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-outline-light" style="border:1.5px solid #45a29e;" onMouseOver="this.style.background='#45a29e'; this.style.color='white';" onMouseOut="this.style.background='none'; this.style.color='white';">DAFTAR</button>
                            </div>
                        </td>
                    </tr>
                    <tr><td><p align="center" style="font-size:11pt; line-height:1;"><br>Sudah punya akun? <a href="index.php" style="color:#c5c6c7">Login di sini</a></p></td></tr>
                </form>
            </table>
        </center>
