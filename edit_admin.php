...
<html>
    <head>
        <title>Edit Admin <?=$data['username']?></title>
    ...
    <body>
        ...
        <br><br>
        <center>
            <h1 class="header" align="center">Edit Data Admin</h1>
            <?php
                if(isset($_GET['pesan']))
                {
            ...
            ?>
            <div class="container">
                <form method="POST" action="edit_proses.php?menu=admin&id=<?=$id?>">
                    <div class="row">
                        <div class=col-4></div>
                        <div class="col-4" style="text-align:left;">
                            <br>
                            <label class="form-label">Username</label>
                            <input class="form-control" type="text" name="username" value="<?=$data['username']?>" aria-label="default input example" style="background-color:transparent; color:#ffffff" required><br>
                            <label class="form-label">Password</label>
                            <input class="form-control" type="password" name="password" value="<?=$data['password']?>" aria-label="default input example" style="background-color:transparent; color:#ffffff" required><br>
